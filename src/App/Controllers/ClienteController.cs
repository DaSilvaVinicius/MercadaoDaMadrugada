...
namespace App.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Telefone,Documento,TipoDocumento")] ClienteViewModel clienteViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nome,Telefone,Documento,TipoDocumento")] ClienteViewModel clienteViewModel)
        {
