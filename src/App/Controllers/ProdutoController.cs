...
namespace App.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Imagem,Valor,EstoqueDisponivel,IdFornecedor")] ProdutoViewModel produtoViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nome,Descricao,Imagem,Valor,EstoqueDisponivel,IdFornecedor")] ProdutoViewModel produtoViewModel)
        {
